$(function () {
    ...
    let switchReadyStatus = $('#switchery_ready_status');
    switchReadyStatus.on('change', function () {
        if (switchReadyStatus.is(":checked") || switchReadyStatus.length === 0) {
            $("#form_ready_status").val("1");
        } else {
            $("#form_ready_status").val("0");
        }
    });
});
