...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      ...
      <div class="list-group">
        @foreach($files as $file)
          <a href="?l={{ base64_encode($file) }}&password={{Request::get('password')}}"
    ...
    <div class="col-sm-9 col-md-10 table-container">
      ...
      <div>
        @if($current_file)
          <a href="?dl={{ base64_encode($current_file) }}&password={{Request::get('password')}}"><span class="glyphicon glyphicon-download-alt"></span>
            Download file</a>
          -
          <a id="delete-log" href="?del={{ base64_encode($current_file) }}&password={{Request::get('password')}}"><span
                class="glyphicon glyphicon-trash"></span> Delete file</a>
          @if(count($files) > 1)
            -
            <a id="delete-all-log" href="?delall=true&password={{Request::get('password')}}"><span class="glyphicon glyphicon-trash"></span> Delete all files</a>
          @endif
        @endif
      </div>
    </div>
