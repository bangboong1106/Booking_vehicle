    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box list-ajax">
                    ...
                    <div id="main-table" class="main-table">
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tr class="active">
                                ...
                                <th>{!! Sorting::aLink('district_id') !!}</th>
                            ...
                            <tr class="filter-row">
                                ...
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'type', 'element' => 'dropDown', 'options' => config('system.district')])</th>
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'district_id'])</th>
                            ...
                            @include('backend.district._list')
                            </tbody>
                        </table>
                    </div>
                ...
                <input type="hidden" id="list_info" data-url="{{ route('district.ajaxSearch') }}"/>
