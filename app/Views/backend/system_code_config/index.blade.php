    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box list-ajax">
                    ...
                    <div id="main-table" class="main-table">
                        ...
                        {{-- <table class="table table-bordered table-hover table-striped">
                            ...
                            <tr class="active">
                                ...
                                <th>{!! Sorting::aLink('prefix') !!}</th>
                                <th>{!! Sorting::aLink('suffix_length') !!}</th>
                                <th>{{ trans('models.system_code_config.attributes.preview') }}</th>
                            </tr>
                            <tr class="filter-row">
                                <th class="text-center"></th>
                                <th></th>
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'type', 'element' => 'dropDown', 'options' => $types])</th>
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'prefix'])</th>
                                <th>@include('layouts.backend.elements._filter_number', ['field' => 'suffix_length'])</th>
                                <th></th>
                            </tr>
                            </thead>
                            <tbody id="body_content">
                            @include('backend.system_code_config._list')
                            </tbody>
                        </table> --}}
                    </div>
                ...
                <input type="hidden" id="list_info" data-url="{{ route('system-code-config.ajaxSearch') }}"/>
