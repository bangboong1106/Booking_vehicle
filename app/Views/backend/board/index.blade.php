...
@section('content')
    ...
    <div class="content-wrapper" style="min-height: 1067px;">
        <div class="container-fluid">
            <div class="row">
                <div class="{!! auth()->user()->can('view revenue') ? 'col-md-3' : 'col-md-4' !!} col-sm-6">
                ...
                <div class="{!! auth()->user()->can('view revenue') ? 'col-md-3' : 'col-md-4' !!} col-sm-6">
                    <div class="card customer-statistic-wrap">
                        <div class="modal" role="dialog" style="top: 20%;" id="customer-statistic-modal">
                            <div class="modal-dialog modal-chart" style="width:30%;height:70%;width:400px;" chartid="1">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4>Chọn tham số</h4>
                                    ...
                                    <div class="modal-body " style="padding: 1rem 1rem 0 1rem;">
                                        <form id="parameter-customer-statistic" data-type=1>


                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    <label>Thời gian</label>
                                                    <div id="report-range-customer-statistic"
                                                         class="pull-right form-control">
                                                        <span></span>
                                                        <i class="pull-right glyphicon-calendar fa fa-calendar"></i>
                                                    </div>
                                    ...
                                    <div class="modal-footer popup-footer">
                                        <button style="color: white; background: #05ACEB" type="button"
                                                class="btn btn-default btn-accept" id="btn-customer-statistic"
                                                data-dismiss="modal">Đồng ý
                                        </button>
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                                    </div>
                        ...
                        <div class="card-header customer-statistic-header">
                            <div class="d-flex justify-content-between">
                                <div class="title">
                                    <span class="card-title">Khách hàng</span>
                                    <span
                                            class="customer-statistic-param-info">trong ngày</span>
                                </div>
                                <div class="navigate-chart">
                                    <img src="{{public_url('/css/backend/img/icons8-refresh-80.png')}}"
                                         id="refresh-customer-statistic" class="refresh-chart-button" title="Nạp">
                                    <img src="{{public_url('/css/backend/img/icons8-filter-80.png')}}" title="Tham số"
                                         data-toggle="modal" data-target="#customer-statistic-modal">
                                </div>
                            </div>

                        </div>
                        <div class="customer-statistic card-body">
                            <div id="chart-customer-statistic-loader" style="display: none;"></div>
                            <div class="row customer-statistic">
                                <div class="col-xl-12 col-md-12" style="padding-left: 8px">
                                    <div class="card-box">
                                        <div class="row justify-content-between">
                                            <div class="col-4 align-self-center">
                                                <i class="fa"></i>
                                            ...
                                            <div class="col-8">
                                                <div class="text-right">
                                                    <h3 class="mb-1 info" name="customer"> 0 </h3>
                                                    <p class="text-muted mb-1">khách hàng</p></div>
                                        ...
                                        <div class="customers row">
                                            <div class="col item">
                                                <div class="row customer-title" style="display: none">
                                                    Top 5 KH phát sinh đơn hàng lớn nhất
                                                </div>
                                            </div>
                                            <div class="w-100"></div>
                                        </div>
            ...
            <div class="row">
                <div class="{!! auth()->user()->can('view revenue') ? 'col-md-6' : 'col-md-12' !!} col-sm-12">
                    <div class="card">
                        <div class="modal" role="dialog" style="top: 20%;" id="turn-by-customer-modal">
                            <div class="modal-dialog modal-chart" style="width:30%;height:70%;width:400px;"
                                 chartid="4">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body modal-parameter" style="padding: 1rem 1rem 0 1rem;">
                                        <form id="parameter-turn-by-customer" data-type=2>
                                            <div class="col-md-12">
                                                <label>Thời gian</label>
                                                <div id="report-range-turn-by-customer"
                                                     class="pull-right form-control">
                                                    <span></span>
                                                    <i class="pull-right glyphicon-calendar fa fa-calendar"></i>
                                                </div>
                                    ...
                                    <div class="modal-footer popup-footer">
                                        <button style="color: white; background: #05ACEB" type="button"
                                                class="btn btn-default btn-accept" id="btn-turn-by-customer"
                                                data-dismiss="modal">Đồng ý
                                        </button>
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng
                                        </button>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h5 class="card-title">Top 10 khách hàng có số đơn hàng lớn nhất</h5>
                                <div class="navigate-chart">
                                    <img src="{{public_url('/css/backend/img/icons8-refresh-80.png')}}"
                                         id="refresh-turn-by-customer" class="refresh-chart-button" title="Nạp">
                                    <span class="expand-chart-container"></span>
                                    <img src="{{public_url('/css/backend/img/icons8-filter-80.png')}}"
                                         title="Tham số"
                                         data-toggle="modal" data-target="#turn-by-customer-modal">
                                </div>
                            </div>
                            <hr>
                            <div class="parameter-detail row">
                        ...
                        <div class="card-body">
                            <div style="display:flex;justify-content:center; margin-top:0px;">
                                <div id="turn-by-customer-label" style="display: block;">
                                    <label>Tổng đơn hàng: <span>0</span></label>
                                </div>
                            </div>
                            <div class="position-relative mb-4">
                                <div id="chart-turn-by-customer-loader" style="display: none;"></div>
                                <div class="row" style="opacity: 1;">
                                    <div class="col-12" name="canvas">
                                        <canvas id="canvas-chart-turn-by-customer"
                                                class="nomal-canvas chartjs-render-monitor"></canvas>
                                    </div>
                                    <div class="" name="table">
                                        <table id="table-turn-by-customer"
                                               class="none-display table-bordered"></table>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                        <div class="modal" role="dialog" style="top: 20%;" id="income-by-customer-modal">
                            <div class="modal-dialog modal-chart" style="width:30%;height:70%;width:400px;"
                                 chartid="2">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body modal-parameter" style="padding: 1rem 1rem 0 1rem;">
                                        <form id="parameter-income-by-customer" data-type=3>
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    <label>Loại thời gian</label>
                                                    <select class="select2" id="report-day-condition-income-by-customer"
                                                            name="">
                                                        <option value="1" {{$dayCondition == 1 ? "selected":""}}>Thời
                                                            gian nhận hàng dự kiến
                                                        </option>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    <label>Thời gian</label>
                                                    <div id="report-range-income-by-customer"
                                                         class="pull-right form-control">
                                                        <span></span>
                                                        <i class="pull-right glyphicon-calendar fa fa-calendar"></i>
                                                    </div>
                                    ...
                                    <div class="modal-footer popup-footer">
                                        <button style="color: white; background: #05ACEB" type="button"
                                                class="btn btn-default btn-accept" id="btn-income-by-customer"
                                                data-dismiss="modal">Đồng ý
                                        </button>
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng
                                        </button>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h5 class="card-title">Top 10 khách hàng có doanh thu cao nhất</h5>
                                <div class="navigate-chart">
                                    <img src="{{public_url('/css/backend/img/icons8-refresh-80.png')}}"
                                         id="refresh-income-by-customer" class="refresh-chart-button" title="Nạp">
                                    <span class="expand-chart-container"></span>
                                    <img src="{{public_url('/css/backend/img/icons8-filter-80.png')}}"
                                         title="Tham số"
                                         data-toggle="modal" data-target="#income-by-customer-modal">
                                </div>
                            </div>
                            <hr>
                            <div class="parameter-detail row">
                        ...
                        <div class="card-body">
                            <div style="display:flex;justify-content:center; margin-top:0px;">
                                <div id="income-by-customer-label" style="display: block;">
                                    <label>Tổng doanh thu: <span>0</span></label>
                                </div>
                            </div>
                            <div class="position-relative mb-4">
                                <div id="chart-income-by-customer-loader" style="display: none;"></div>
                                <div class="row" style="opacity: 1;">
                                    <div class="col-12" name="canvas">
                                        <canvas id="canvas-chart-income-by-customer"
                                                class="nomal-canvas chartjs-render-monitor"></canvas>
                                    </div>
                                    <div class="" name="table">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="card">
                        <div class="modal" role="dialog" style="top: 20%;" id="goods-by-time-modal">
                            <div class="modal-dialog modal-chart" style="width:30%;height:70%;width:400px;"
                                 chartid="1">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body modal-parameter" style="padding: 1rem 1rem 0 1rem;">
                                        <form id="parameter-goods-by-time" data-type=1>
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    <label>Loại thời gian</label>
                                                    <select class="select2" id="report-day-condition-goods-by-time"
                                                            name="">
                                                        <option value="1" {{$dayCondition == 1 ? "selected":""}}>Thời
                                                            gian nhận hàng dự kiến
                                                        </option>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    <label>Thời gian</label>
                                                    <div id="report-range-goods-by-time"
                                                         class="pull-right form-control">
                                                        <span></span>
                                                        <i class="pull-right glyphicon-calendar fa fa-calendar"></i>
                                                    </div>
                                    ...
                                    <div class="modal-footer popup-footer">
                                        <button style="color: white; background: #05ACEB" type="button"
                                                class="btn btn-default btn-accept" id="btn-goods-by-time"
                                                data-dismiss="modal">Đồng ý
                                        </button>
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng
                                        </button>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h5 class="card-title">Thống kê sản lượng hàng hoá theo thời gian</h5>
                                <div class="navigate-chart">
                                    <img src="{{public_url('/css/backend/img/icons8-refresh-80.png')}}"
                                         id="refresh-goods-by-time" class="refresh-chart-button" title="Nạp">
                                    <span class="expand-chart-container"></span>
                                    <img src="{{public_url('/css/backend/img/icons8-filter-80.png')}}"
                                         title="Tham số"
                                         data-toggle="modal" data-target="#goods-by-time-modal">
                                </div>
                            </div>
                            <hr>
                            <div class="parameter-detail row">
                        ...
                        <div class="card-body">
                            <div style="display:flex;justify-content:center; margin-top:0px;">
                                <div id="goods-by-time-label" style="display: block;">
                                    <label><span>0</span></label>
                                </div>
                            </div>
                            <div class="position-relative mb-4">
                                <div id="chart-goods-by-time-loader" style="display: none;"></div>
                                <div class="row" style="opacity: 1;">
                                    <canvas id="canvas-chart-goods-by-time"
                                            class="nomal-canvas chartjs-render-monitor"></canvas>
                                </div>
                            </div>
                        </div>
