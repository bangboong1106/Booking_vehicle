    ...
    <div id="deleted-table" class="main-table">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr class="active">
                ...
                <th style="width:250px">{!! Sorting::aLink('ETA_date_reality',trans('models.order_customer.attributes.ETA_date_reality')) !!}</th>
                <th style="width:250px">{!! Sorting::aLink('location_destination',trans('models.order_customer.attributes.location_destination')) !!}</th>
                <th style="width: 250px">{!! Sorting::aLink('location_arrival',trans('models.order_customer.attributes.location_arrival')) !!}</th>
                <th style="width: 200px">{!! Sorting::aLink('amount') !!}</th>
                <th style="width: 200px">{!! Sorting::aLink('commission_amount') !!}</th>
                <th style="width: 220px">{!! Sorting::aLink('ETD_date',trans('models.order_customer.attributes.ETD_date')) !!}</th>
                <th style="width: 220px">{!! Sorting::aLink('ETA_date',trans('models.order_customer.attributes.ETA_date')) !!}</th>
                <th style="width:  150px">{!! Sorting::aLink('vehicle_group_id') !!}</th>
                <th style="width: 150px">{!! Sorting::aLink('vehicle_number') !!}</th>
