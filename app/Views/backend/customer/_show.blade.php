            ...
            <ul class="list-related-list">
                <li>
                    ...
                    <ul>
                        ...
                        <li><a class="list-info" data-dest="headingClient"
                               href="#"> Thông tin khách hàng</a></li>
                        <li><a class="list-info" data-dest="headingStaff"
                               href="#"> Thông tin nhân viên</a></li>
                    </ul>
                </li>
                <li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 content-detail">
                        ...
                        <div class="card-header" role="tab"
                             id="headingClient">
                            <h5 class="mb-0 mt-0 font-16">
                                <a data-toggle="collapse" href="#collapseClient" aria-expanded="true"
                                   aria-controls="collapseClient" class="">
                                    Thông tin các khách hàng
                                    <i class="fa"></i>
                                </a>
                            </h5>
                        </div>
                        <div id="collapseClient" class="collapse show" role="tabpanel"
                             aria-labelledby="headingOne"
                             style="">
                            <div class="card-body">
                                <table class="table table-bordered table-hover" style="width: 75% !important;">
                                    ...
                                    <tr class="active">
                                        ...
                                        <th scope="col" class="text-left">Mã khách hàng</th>
                                        <th scope="col" class="text-left">Tên khách hàng</th>
                                        <th scope="col" class="text-left">Số điện thoại</th>
                                        <th scope="col" class="text-left">Người tạo</th>
                                        <th scope="col" class="text-left">Người sửa</th>
                                    </tr>
                                    </thead>
                                    <tbody id="body_content">
                                    @if(isset($listCustomer))
                                        @php $clientIndex = 1 @endphp
                                        @foreach($listCustomer as  $index => $customer)
                                            @if($customer->type == 1)
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        {{$customer->ai_username}}
                                                    </td>
                                                    <td class="text-left">
                                                        {{$customer->au_username}}
                                                    </td>
                                                </tr>
                                            @endif
                                        @endforeach
                        ...
                        <div class="card-header" role="tab"
                             id="headingStaff">
                            <h5 class="mb-0 mt-0 font-16">
                                <a data-toggle="collapse" href="#collapseStaff" aria-expanded="true"
                                   aria-controls="collapseStaff" class="">
                                    Thông tin các nhân viên
                                    <i class="fa"></i>
                                </a>
                            </h5>
                        </div>
                        <div id="collapseStaff" class="collapse show" role="tabpanel"
                             aria-labelledby="headingOne"
                             style="">
                            <div class="card-body">
                                <table class="table table-bordered table-hover" style="width: 75% !important;">
                                    ...
                                    <tr class="active">
                                        ...
                                        <th scope="col" class="text-left">Mã nhân viên</th>
                                        <th scope="col" class="text-left">Tên nhân viên</th>
                                        <th scope="col" class="text-left">Số điện thoại</th>
                                        <th scope="col" class="text-left">Người tạo</th>
                                        <th scope="col" class="text-left">Người sửa</th>
                                    </tr>
