...
<div class="table-responsive import-table-scroll">
    <table class="table table-bordered table-hover table-striped">
        ...
        <tr>
            ...
            <th style="width: 100px">{{ trans('models.customer.attributes.customer_code') }}</th>
            <th style="width: 100px">{{ trans('models.customer.attributes.full_name') }}</th>
            <th style="width: 100px">{{ trans('models.customer.attributes.type') }}</th>
            ...
            <th style="width: 150px">{{ trans('models.customer.attributes.mobile_no') }}</th>
            <th style="width: 150px">{{ trans('models.customer.attributes.delegate') }}</th>
            <th style="width: 150px">{{ trans('models.customer.attributes.tax_code') }}</th>
            <th style="width: 200px">{{ trans('models.customer.attributes.address') }}</th>
            <th style="width: 150px">{{ trans('models.customer.attributes.birth_date') }}</th>
            <th style="width: 150px">{{ trans('models.customer.attributes.sex') }}</th>
            <th style="width: 150px">{{ trans('models.customer.attributes.note') }}</th>
        </tr>
        </thead>
        <tbody>
