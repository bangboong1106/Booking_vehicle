...
<div class="row">
    <div class="col-12">
        {!! MyForm::model($entity, ['route' => ['partner-driver.valid', $entity->id]])!!}
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="create_account row">
                                        {!! MyForm::checkbox('create_account',$create_account_flag ? 1 : 0, $create_account_flag, ['data-plugin' => "switchery", 'data-color' => "#6610f2a6", 'class' => 'switchery', 'id' => 'create_account']) !!}
                                        <span style="margin-left: 8px;">Mở tài khoản</span>
                                    </div>
