...
{{-- <tr class="active">
    ...
    <th style="width:230px">{!! Sorting::aLink('type') !!}</th>
...
<tr class="filter-row">
    ...
    <th>@include('layouts.backend.elements._filter_string', ['field' => 'type', 'element' => 'dropDown', 'options' => config('system.price_quote_type') ])</th>
