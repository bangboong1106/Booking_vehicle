...
<div class="row">
    <div class="col-12">
        {!! MyForm::model($entity, ['route' => ['partner-vehicle.valid', $entity->id]])!!}
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend">
                                        <select class="select2 select-driver" id="listDriver[]"
                                                name="listDriver[]" multiple='multiple'>
                                        ...
                                        {{--                                                                                {!! MyForm::dropDown('listDriver[]', isset($entity->listDriver) ?--}}
                                        {{--                                                                                    $entity->listDriver : $entity->drivers, $driverList, false,--}}
                                        {{--                                                                                ['multiple' => 'multiple', 'class' => 'select2 minimal select-driver', 'style'=>'visibility: hidden']) !!}--}}

                                        <span class="input-group-addon driver-search" data-type="multiple">
