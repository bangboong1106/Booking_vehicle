    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box list-ajax">
                    ...
                    <div id="main-table" class="main-table">
                        <table class="table table-bordered table-hover table-striped table-striped">
                            ...
                            <tr class="active">
                                ...
                                <th>{!! Sorting::aLink('ward_id') !!}</th>
                                <th>{!! Sorting::aLink('title') !!}</th>
                                <th>{!! Sorting::aLink('type') !!}</th>
                                <th>{!! Sorting::aLink('district') !!}</th>
                                <th>{!! Sorting::aLink('province') !!}</th>
                            ...
                            <tr class="filter-row">
                                <th></th>
                                <th></th>
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'ward_id'])</th>
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'title'])</th>
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'type', 'element' => 'dropDown', 'options' => config('system.ward')])</th>
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'district'])</th>
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'province'])</th>
                ...
                <input type="hidden" id="list_info" data-url="{{ route('ward.ajaxSearch') }}"/>
