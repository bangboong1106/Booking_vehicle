            ...
            <div class="toolbar btn-group" role="group" aria-label="Basic example">
                ...
                <div class="toolbar dropdown action">
                    ...
                    <div class="dropdown-menu  dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item download-item" target="_blank" data-type={{config('constant.QUOTA')}}
                                data-url="{{route('template.mergeTemplate', -1)}}">
                            Bảng định mức chi phí
                        </a>
                        <a class="dropdown-item download-item" target="_blank" data-type={{config('constant.CUSTOMER')}}
                                data-url="{{route('template.mergeTemplate', -1)}}">
                            Khách hàng
                        </a>
                        ...
                        <a class="dropdown-item download-item" target="_blank" data-type={{config('constant.ORDER_CUSTOMER')}}
                                data-url="{{route('template.mergeTemplate', -1)}}">
                            Đơn hàng đặt hàng
                        </a>
                    </div>
