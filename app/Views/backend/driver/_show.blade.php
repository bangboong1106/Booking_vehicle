                            ...
                            <div id="collapseInformation" class="collapse show" role="tabpanel"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 edit-group-control">
                                            <label for="ready_status">{{ trans('models.driver.attributes.ready_status') }}</label><br>
                                            <p>{{ $entity->ready_status == 1 ? 'Có' : 'Không'}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <?php
                                        $tempVehicleTeamList = '';
                                        $numItemsVehicleTeams = count($entity->vehicleTeams);
                                        $i = 0;
                                        foreach ($entity->vehicleTeams as $index => $vehicleTeam) {
                                            if (Auth::user()->can('view vehicle_team')) {
                                                ...
                                                $tempVehicleTeamList .= $vehicleTeam->name;
                                                if (++$i !== $numItemsVehicleTeams) {
                                                    $tempVehicleTeamList .= ' - ';
                                                }
                                            }
                                        }
                                    ...
                                    <div class="form-group row">
                                        <?php
                                        $tempVehicleList = '';
                                        $numItemsVehicle = count($entity->vehicles);
                                        $y = 0;
                                        if (!empty($entity->id)) {
                                            foreach ($entity->vehicles as $index => $vehicle) {
                                                if (Auth::user()->can('view vehicle')) {
                                                    ...
                                                    $tempVehicleList .= $vehicle->reg_no;
                                                    if (++$y !== $numItemsVehicle) {
                                                        $tempVehicleList .= ' | ';
                                                    }
                                                }
                                            }
