    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box list-ajax">
                    ...
                    <div id="main-table" class="main-table">
                        ...
                        {{-- <table class="table table-bordered table-hover table-striped">
                            ...
                            <tr class="filter-row">
                                ...
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'type', 'element' => 'dropDown', 'options' => config('system.column_type')])</th>
                                <th>@include('layouts.backend.elements._filter_string', ['field' => 'active', 'element' => 'dropDown', 'options' => config('system.active')])</th>
                            </tr>
                            </thead>
                            <tbody id="body_content">
                            @include('backend.vehicle_config_specification._list')
                            </tbody>
                        </table> --}}
                    </div>
                ...
                <input type="hidden" id="list_info" data-url="{{ route('vehicle-config-specification.ajaxSearch') }}"/>
