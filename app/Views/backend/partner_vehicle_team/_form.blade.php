...
<div class="row">
    <div class="col-12 offset-3">
        {!! MyForm::model($entity, ['route' => ['partner-vehicle-team.valid', $entity->id]])!!}
                        ...
                        <div class="advanced form-group row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group select2-bootstrap-prepend">
                                    ...
                                    <span class="input-group-addon" id="primary-driver-search-wrap">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group select2-bootstrap-prepend">
                                    ...
                                    <span class="input-group-addon driver-search"
                                          id="team-driver-search" data-type="multiple">
                                                    <div class="input-group-text bg-transparent">
