<?php
    $attributes = getColumnConfig("partner_template");
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box list-ajax">
                @include('backend.partner_template._index_head')
                ...
                <input type="hidden" id="list_info" data-url="{{ route('partner-template.ajaxSearch') }}"/>
