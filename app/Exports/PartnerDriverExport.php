...
class PartnerDriverExport implements FromView, ShouldAutoSize, WithColumnFormatting
{
    ...
    public function __construct(PartnerDriverRepository $partnerDriverRepository, $data = [])
    {
    ...
    public function exportFromTemplate($update = false, $dataVehicleTeam)
    {
        try {
            $fileTemplatePath = public_path('file/Danh_sach_tai_xe_partner.xlsx');
