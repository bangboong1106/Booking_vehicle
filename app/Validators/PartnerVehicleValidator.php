...
/**
 * Class PartnerVehicleValidator
 * @package App\Validator
 */
class PartnerVehicleValidator extends BaseValidator
{
    /**
     * @return array
     */
    ...
    protected function _getMessagesDefault()
    {
        return [
            ...
            '*.group_code.required' => trans('validation.exists', ['attribute' => trans('models.vehicle.attributes.group_id')]),
