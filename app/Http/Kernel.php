...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'super_admin_backend' => \App\Http\Middleware\SuperAdminAuthenticated::class,
        'auth.api' => \App\Http\Middleware\ApiAuthenticated::class,
        'throttle' => \Illuminate\Routing\Middleware\ThrottleRequests::class,
        'log.viewer' => \App\Http\Middleware\LogViewer::class,
        'auth.jwt' => \Tymon\JWTAuth\Http\Middleware\Authenticate::class,

        'fjwt.auth' => \Tymon\JWTAuth\Http\Middleware\Authenticate::class,
        'fjwt.refresh' => \Tymon\JWTAuth\Http\Middleware\RefreshToken::class,
