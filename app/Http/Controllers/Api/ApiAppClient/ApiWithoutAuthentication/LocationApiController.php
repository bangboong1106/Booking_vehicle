...
{
    public function __construct( CustomerRepository $customerRepository,LocationClientRepository $locationClientRepository)
    {
        parent::__construct($customerRepository);
        $this->setRepository($locationClientRepository);
    }
