...
{
    public function __construct( CustomerRepository $customerRepository,GoodsTypeClientRepository $goodsTypeClientRepository)
    {
        parent::__construct($customerRepository);
        $this->setRepository($goodsTypeClientRepository);
    }
