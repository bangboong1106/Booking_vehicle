...
use App\Repositories\PartnerAdminUserInfoRepository;
 ...
 */
class PartnerAdminController extends BackendController
{
     ...
     * @param PartnerAdminUserInfoRepository $partnerAdminUserInfoRepository
     ...
     */
    public function __construct(PartnerAdminUserInfoRepository $partnerAdminUserInfoRepository,
    ...
    {
        parent::__construct();
        $this->setRepository($partnerAdminUserInfoRepository);
        $this->setBackUrlDefault('partner-admin.index');
        $this->setConfirmRoute('partner-admin.confirm');
        $this->setMenu('partner_admin');
    ...
    {
        $currentUser = $this->getCurrentUser();
        if (!$currentUser->can('edit partner_admin') && $currentUser->id !== (int)$id) {
    ...
    protected function _prepareForm()
    {
        ...
        $this->setViewData([
            'roles' => $this->getRoleRepository()->getAllRolePartner(),
            'vehicleTeamList' => $this->getVehicleTeamRepository()->getListForSelect(),
            'customerGroupList' => $this->getCustomerGroupRepository()->getListForSelect(),
